variable "aws_region" {
  description = "AWS Region for dev1."
  type        = string
  default     = "us-west-2"
}
...
variable "environment_enabled" {
  description = "Creates dev1 resources when true."
  type        = bool
  default     = true
}

variable "deploy_lambdas" {
  description = "Deploys functions after images exist in ECR. Set false for the bootstrap apply."
  type        = bool
  default     = true
}
...
variable "image_tag" {
  description = "Docker image tag for dev1."
  type        = string
  default     = "dev1"
}
...
variable "enable_cloudwatch_logs" {
  description = "Enables short-retention Lambda logs."
  type        = bool
  default     = true
}

variable "enable_xray_tracing" {
  description = "Enables paid X-Ray tracing."
  type        = bool
  default     = false
}
