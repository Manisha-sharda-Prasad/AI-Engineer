...
export default function Profile({ showTitle = true }) {
  ...
  if (!firebaseEnabled) return <div className="card profile-card">{showTitle && <h1>Profile</h1>}<p>Firebase is not configured for this environment yet.</p></div>
